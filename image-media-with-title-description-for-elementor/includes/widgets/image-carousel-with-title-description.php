...
class Image_carousel_with_title_description extends Base
{
  ...
  protected function add_repeater_controls(Repeater $repeater)
  {
    ...
    $repeater->add_control(
      ...
      [
        ...
        'description' => __('VIdeo Url', 'elementor-pro'),
        'options' => false,
        'condition' => [
          'type' => 'video',
        ],
    ...
    $repeater->add_control(
      'image_title',
      [
        'label' => __('Image Title', 'elementor-pro'),
        'type' => Controls_Manager::TEXT,
        'placeholder' => __('Enter image title', 'elementor-pro'),
        'description' => __('Enter image title', 'elementor-pro'),
        'options' => false,
        'condition' => [
          'type' => 'image',
        ],
    ...
    $repeater->add_control(
      'read_more_link',
      [
        'label' => __('Read More Link', 'elementor-pro'),
        'type' => Controls_Manager::TEXT,
        'placeholder' => __('Enter link for read more button', 'elementor-pro'),
        'description' => __('Enter link for read more button', 'elementor-pro'),
        'options' => false,
        'condition' => [
          'type' => 'image',
        ],
    ...
    $repeater->add_control(
      'image_description',
      [
        'label' => __('Image Description', 'elementor-pro'),
        'type' => Controls_Manager::TEXTAREA,
        'placeholder' => __('Enter image description', 'elementor-pro'),
        'description' => __('Enter image description', 'elementor-pro'),
        'options' => false,
        'condition' => [
          'type' => 'image',
        ],
  ...
  protected function print_slide(array $slide, array $settings, $element_key)
  {
    ...
    if ($image_link_to && empty($settings['thumbs_slider'])) {
      ...
      if ('video' === $slide['type'] && $slide['video']['url']) {
        ...
        $embd_url = Embed::get_embed_url($slide['video']['url'], $embed_url_params);
        if ($embd_url) {
          $data = $embd_url;
          //$this->add_render_attribute($element_key . '_link', 'data-elementor-lightbox', '');
        } else {
          $video_url = $slide['video']['url'];
          if (!empty($video_url)) {
            $data = '{"type":"video","videoType":"hosted","url":"' . $video_url . '","videoParams":{"controls":"","controlsList":"nodownload"}}';
            $this->add_render_attribute($element_key . '_link', 'data-elementor-lightbox', $data);
          } else {
            $data = '';
            //$this->add_render_attribute($element_key . '_link', 'data-elementor-lightbox', $data);
          }
...
?>
	...
	<div class="uc_image_carousel_content">
                <a href="<?= $slide['read_more_link']; ?>" style="text-decoration:none;"><div class="uc_post_title" style="text-decoration:none;"><?= $slide['image_title']; ?></div></a>    <div class="ue_post_intro"><?= $slide['image_description']; ?></div>    <div class="ue_post_btn_holder"><a class="uc_more_btn" href="<?= $slide['read_more_link']; ?>">Read More ...</a></div>  </div>
